...
enum EPetEffectName {
    ArgentParHeure = "$/h",
    ArgentMétiers = "% d'argent Métiers",
    ArgentPêcheur = "% d'argent Pêcheur",
    ArgentFermier = "% d'argent Fermier",
    ArgentForgemage = "% d'argent Forgemage",
    ArgentChasseur = "% d'argent Chasseur",
    ArgentMineur = "% d'argent Mineur",
    ArgentBûcheron = "% d'argent Bûcheron",
